...
const CustomerPayment = () => {
  ...
  useEffect(() => {
    axios
      .get("https://backendback.vercel.app/api/customer/customers")
  ...
  useEffect(() => {
    if (selectedCustomer) {
      axios
        .get(`https://backendback.vercel.app/api/customer/customers/${selectedCustomer}`)
        .then((response) => {
  ...
  const handleDebitSubmission = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://backendback.vercel.app/api/customer/updateBalance/${selectedCustomer}`,
        {
          debit: debitAmount,
        }
      );
      ...
      const recordsResponse = await axios.get(
        `https://backendback.vercel.app/api/customer/customers/${selectedCustomer}`
      );
  ...
  const handleDeleteRecord = async (recordId, debitAmount) => {
    try {
      ...
      await axios.delete(
        `https://backendback.vercel.app/api/customer/customers/${selectedCustomer}/dateWiseRecords/${recordId}`
      );
