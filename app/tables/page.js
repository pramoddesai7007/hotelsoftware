...
const Tables = () => {
    ...
    const handleView = async (tableId) => {
        try {
            const response = await axios.get(`https://backendback.vercel.app/api/table/tables/${tableId}`);
    ...
    const handleEditSubmit = async () => {
        try {
            ...
            const response = await axios.patch(
                `https://backendback.vercel.app/api/table/tables/${editTable._id}`,
                formData,
                {
                    headers: {
    ...
    useEffect(() => {
        const fetchTables = async () => {
            try {
                const tablesResponse = await axios.get('https://backendback.vercel.app/api/table/tables');
        ...
        const fetchSections = async () => {
            try {
                const sectionsResponse = await axios.get('https://backendback.vercel.app/api/section');
    ...
    const handleAddSubmit = async () => {
        try {
            ...
            const response = await axios.post(
                `https://backendback.vercel.app/api/table/${sectionId}/tables`,
                formData,
                {
                    headers: {
                        "Content-Type": "application/json",
    ...
    useEffect(() => {
        const fetchtables = async () => {
            try {
                const response = await axios.get('https://backendback.vercel.app/api/table/tables');
    ...
    const confirmDelete = async () => {
        try {
            ...
            const response = await axios.delete(
                `https://backendback.vercel.app/api/table/tables/${tableToDelete._id}`
            );
        ...
        <>
            ...
            <div className="container mx-auto p-2 w-full mt-12 overflow-x-auto  border-gray-300 shadow-md font-sans max-w-5xl">
                <div className="flex items-center justify-between">
                    <h1 className="text-xl font-bold font-sans mb-2 md:mb-0 text-orange-600 pl-4">Tables</h1>
