...
const Reports = () => {
  ...
  const fetchOrders = async () => {
    try {
      ...
      const response = await axios.get(
        `https://backendback.vercel.app/api/order/orders/date?startDate=${startDate}&endDate=${endDate}`
      );
        ...
        <div class="report-content">
          <table class="table">
            ...
            <tbody>
              ...
              <td>₹${calculateTotal("cashAmount")}</td>
              <td>₹${calculateTotal("onlinePaymentAmount")}</td>
