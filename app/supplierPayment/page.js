...
const SupplierPayment = () => {
    ...
    useEffect(() => {
        axios.get('https://backendback.vercel.app/api/supplier/suppliers')
    ...
    useEffect(() => {
        if (selectedSupplier) {
            axios.get(`https://backendback.vercel.app/api/supplier/suppliers/${selectedSupplier}`)
                .then(response => {
    ...
    const handleDebitSubmission = (e) => {
        ...
        if (debitAmount <= creditBalance && !loading) {
            ...
            axios.put(`https://backendback.vercel.app/api/supplier/updateBalance/${selectedSupplier}`, {
                debit: debitAmount,
            })
                .then(response => {
        ...
        <>
            ...
            <div className="max-w-5xl mx-auto bg-white p-8 shadow-md font-sans mt-11">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="w-md bg-gray-100 p-4 rounded ml-8 h-min mt-20 ">
