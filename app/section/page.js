...
const Section = () => {
  ...
  useEffect(() => {
    const fetchSections = async () => {
      try {
        const response = await axios.get("https://backendback.vercel.app/api/section");
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      ...
      await axios.patch(
        `https://backendback.vercel.app/api/section/${sectionToEdit._id}`,
        {
  ...
  const handleDeleteConfirmed = async () => {
    ...
    try {
      await axios.delete(
        `https://backendback.vercel.app/api/section/${sectionToDelete._id}`
      );
      ...
      const sectionsResponse = await axios.get(
        "https://backendback.vercel.app/api/section"
      );
  ...
  const handleAddSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        "https://backendback.vercel.app/api/section/create",
        formData,
        {
          headers: {
      ...
      <div className="">
        ...
        <div className="container mx-auto p-2 w-full mt-14 overflow-x-auto  border-gray-300 shadow-md font-sans max-w-5xl">
          <div className="flex items-center justify-between">
            <h1 className="text-xl font-bold font-sans mb-2 md:mb-0 text-orange-600 pl-4">Sections</h1>
