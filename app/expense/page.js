...
const ExpenseList = () => {
  ...
  useEffect(() => {
    const fetchExpenses = async () => {
      try {
        const response = await axios.get('https://backendback.vercel.app/api/expense/expenses');
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      await axios.patch(`https://backendback.vercel.app/api/expense/expenses/${selectedExpense._id}`, {
  ...
  const handleDeleteSubmit = async () => {
    try {
      await axios.delete(`https://backendback.vercel.app/api/expense/expenses/${selectedExpense._id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://backendback.vercel.app/api/expense/expenses', { expense: newExpense });
  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto bg-white p-4 rounded-lg shadow-md mt-20">
        <h2 className='text-center font-bold'>Expense Master</h2>
        ...
        {loading ? (
          ...
          <div className="overflow-auto max-h-full">
            ...
            <thead className="text-sm bg-zinc-100 text-yellow-600 ">
                <tr>
                  <th className="p-2 text-left text-gray lg:pl-32 pl-4">Expense</th>
