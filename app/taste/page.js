...
const TasteList = () => {
  ...
  useEffect(() => {
    const fetchTastes = async () => {
      try {
        const response = await axios.get('https://backendback.vercel.app/api/taste/tastes');
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      await axios.patch(`https://backendback.vercel.app/api/taste/tastes/${selectedTaste._id}`, {
  ...
  const handleDeleteSubmit = async () => {
    try {
      ...
      await axios.delete(`https://backendback.vercel.app/api/taste/tastes/${selectedTaste._id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://backendback.vercel.app/api/taste/tastes', { taste: newTaste });
  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto bg-white p-4 rounded-lg shadow-md mt-12">
      <h1 className="text-xl font-bold font-sans md:mb-0 text-orange-600">Taste</h1>
