...
const SupplierList = () => {
    ...
    useEffect(() => {
        const fetchSuppliers = async () => {
            try {
                const response = await axios.get('https://backendback.vercel.app/api/supplier/suppliers');
    ...
    const handleDeleteConfirmed = async () => {
        try {
            ...
            await axios.delete(`https://backendback.vercel.app/api/supplier/suppliers/${editedSupplier._id}`);
